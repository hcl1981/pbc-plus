...
FULL = (0x20, 0x5A)
# Hier deckt auch die Titelgroesse den vollen Satz ab: Flash ist in diesem
# Projekt reichlich (die Muster brauchen nur 27 KB), und der Titel besteht
# nicht aus einem festen Wort.
TITLE = FULL
...
FONTS = [
    ...
    dict(name="ui_xl", ttf=CND, px=44, rng=TITLE),  # Titelschrift
]
...
def main():
    ...
    checks = [("ui_xl", "NOIZ", 200), ("ui_m", "2SA", 200),
              ("ui_m", "A OR B = START", 200), ("ui_m", "STAGE ENDLESS INSANE", 200),
              ("ui_s", "LEFT RIGHT SELECT", 200), ("ui_l", "GAME OVER", 240),
              ("ui_l", "STAGE CLEAR", 240), ("ui_s", "A OR B = RESUME", 240),
              ("ui_m", "1234567", 120), ("ui_s", "SHIPS 2", 120)]
    print("\nBreitenpruefung:")
