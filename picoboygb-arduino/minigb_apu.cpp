...
// __not_in_flash_func() wird via pico.h reingezogen. pico/platform.h direkt
// includieren ist in neuen pico-sdk-Versionen verboten (#error).
#ifdef __has_include
...
// pico-sdk definiert ebenfalls MAX/MIN. Vor unserer Definition aufraeumen.
#ifdef MAX
#  undef MAX
#endif
#ifdef MIN
 ...
 */
void __not_in_flash_func(audio_callback)(void *userdata, int16_t *stream, size_t len)
{
