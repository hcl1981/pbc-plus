...
/*
 * PicoBoy-Aenderung: Zeiger ins Flash-Archiv statt Feld im RAM (23 KB).
 *
 * Die Palettendatei wird von tools/mkdata.py bereits im Speicherformat
 * abgelegt (SDL_Color, 8 Bit je Anteil) -- JE_loadPals muss deshalb nichts
 * mehr umrechnen und zeigt nur noch dorthin.
 *
 * Der Zeiger ist absichtlich nicht const: set_palette und die Ueberblendungen
 * nehmen Palette ohne const entgegen, und diese Signaturen zu aendern haette
 * sich durch ein Dutzend Dateien gezogen. Geschrieben wird hier nichts -- die
 * Arbeitskopie ist "colors" bzw. "palette", nicht dieses Feld.
 */
