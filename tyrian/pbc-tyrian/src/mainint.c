...
JE_boolean JE_inGameSetup(void)
{
	...
	/*
	 * PicoBoy: Einstellungen hier sichern, nicht erst beim Beenden.
	 *
	 * Im Original wird saveConfiguration() nur aus JE_tyrianHalt gerufen --
	 * also wenn man das Spiel verlaesst. Auf einem Handheld verlaesst man es
	 * nicht, man schaltet es aus. Ohne diesen Aufruf waere jede Aenderung an
	 * Detailgrad, Lautstaerke oder Tastenbelegung beim naechsten Einschalten
	 * wieder weg.
	 */
	saveConfiguration();
...
void JE_playCredits(void)
{
	...
	/* PicoBoy: 8,7 KB gehoeren nicht auf einen 4-KB-Stapel. */
	static char credstr[lines_max][line_max_length + 1];
