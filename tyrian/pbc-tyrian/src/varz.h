...
/*
 * PicoBoy-Aenderung: die shapes[]-Felder sind entfallen.
 *
 * Im Original hielt jede Kartenebene ihre Kachelgrafiken selbst -- zusammen
 * 143 KB, die beim Levelladen aus shapes*.dat hineinkopiert wurden. Die Kacheln
 * liegen dort aber UNKOMPRIMIERT (je Kachel ein Flag und 672 Byte), und das
 * Flash ist beim RP2350 in den Adressraum eingeblendet. Sie sind also bereits
 * lesbar da, wo sie liegen; mainmap zeigt jetzt direkt dorthin.
 *
 * mainmap selbst bleibt unveraendert ein Feld von Zeigern -- es aendert sich
 * nur, WOHIN sie zeigen. Der Renderer merkt davon nichts.
 *
 * Das Feld "fill" ist mit entfallen: es wurde beim Laden berechnet und
 * geschrieben, aber an keiner Stelle je gelesen -- ein Ueberbleibsel der
 * DOS-Fassung.
 */
