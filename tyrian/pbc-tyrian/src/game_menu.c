...
{
	/* PicoBoy: ab hier spannt sich der Inhalt ueber die volle Breite --
	   verkleinert statt ausschnittweise. Siehe platform/pbc_video.h. */
	pbc_set_view_mode(PBC_VIEW_SHOP);
