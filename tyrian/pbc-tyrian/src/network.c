...
/*
 * PicoBoy: 64 statt 256.
 *
 * Der USB-Link traegt hoechstens 36 Byte Nutzlast je Austausch, groessere
 * Puffer koennten also nie gefuellt werden. Dafuer legt network.c bis zu 80
 * Pakete an (fuenf Warteschlangen zu je 16) -- bei 256 Byte waeren das rund
 * 23 KB Heap, und so viel gibt es hier nicht.
 *
 * Untergrenze ist die Zusicherung in network_connect: 12 + Name + 1.
 */
#define NET_PACKET_SIZE   64
