...
/*
 * PicoBoy: es gibt kein Fenster, also kann es den Fokus nicht verlieren.
 *
 * tyrian2.c pausiert das Spiel bei "!windowHasFocus". Ohne Fensterereignisse
 * blieb das Flag auf false stehen -- das Spiel sprang deshalb staendig von
 * selbst in die Pause.
 */
