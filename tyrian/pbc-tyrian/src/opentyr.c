...
void setupMenu(void)
{
	...
	/* PicoBoy: siehe JE_inGameSetup in mainint.c -- ohne das gingen die
	   Einstellungen beim Ausschalten verloren. */
	saveConfiguration();
...
#endif
		{
			/* PicoBoy: Titel und Menues zeigen das ganze 320x200-Bild. */
