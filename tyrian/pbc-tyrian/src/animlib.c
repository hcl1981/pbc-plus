...
void playAnim(const char *filename, Uint8 startingFrame, Uint8 speed)
{
	...
	static SDL_Color palette[256];   /* PicoBoy: Stapel schonen */
	...
	static PageDescriptor pageDescriptors[256];   /* PicoBoy: Stapel schonen */
	...
	/*
	 * PicoBoy-Anmerkung: diese beiden Puffer sind zusammen 128 KB. Auf einem
	 * Geraet mit 512 KB, von denen Tyrian schon fast alles fuer Bildschirme
	 * und Kartendaten belegt, ist das nicht zu haben. Statt hier abzustuerzen
	 * wird die Schlussanimation ausgelassen -- sie ist das Einzige, was daran
	 * haengt, und ein uebersprungener Abspann ist allemal besser als ein
	 * eingefrorenes Geraet nach dem gewonnenen Spiel.
	 *
	 * Wer sie sehen will, muss anderswo Speicher freimachen; mit
	 * tools/mkdata.py --no-ending laesst sich umgekehrt der Platz im Flash
	 * (3,3 MB) zurueckgewinnen.
	 */
